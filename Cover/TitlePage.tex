...
\vspace{-\parskip}
\flushleft
\fontsize{40}{42}\selectfont \textcolor{bluetitle}{Combining climate and remote sensing data in species distribution models}\\[1.5mm]
\end{textblock}
...
\vspace{-\parskip}
\flushright
\fontsize{14}{16}\selectfont \textbf{Jorne Biccler}
\end{textblock}
%
...
\vspace{-\parskip}
\flushleft
Supervisor: Prof.\ B.\ Sandel\\[-2pt]
\textcolor{blueaff}{Aarhus University}\\[5pt]
Supervisor: Prof.\ T.\ Verdonck\\[-2pt]
\textcolor{blueaff}{KU Leuven}\\[5pt]
Co-supervisor: Prof.\ J.C.\ Svenning\\[-2pt]
\textcolor{blueaff}{Aarhus University}
\end{textblock}
%
